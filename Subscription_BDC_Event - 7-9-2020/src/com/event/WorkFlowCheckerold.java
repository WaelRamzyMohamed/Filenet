...
public class WorkFlowCheckerold implements EventActionHandler {

	public WorkFlowCheckerold() {
	}
...
String BM_ATT_ROUTE = fnProperties.getStringValue("DocumentStatus");
String BM_ATT_ROUTE2 = fnProperties.getStringValue("Checkoutdocument");

 		///////////////////////////////////////sleep case of Ã˜Â¥Ã˜Â±Ã˜Â³Ã˜Â§Ã™â€ž Ã™â€žÃ™â€žÃ™â€¦Ã˜Â±Ã˜Â§Ã˜Â¬Ã˜Â¹ ////////////////////////////////
...
///////////////////////////////////////sleep case of Ã˜ÂªÃ™â€¦ Ã˜Â§Ã™â€žÃ˜Â¥Ã˜Â³Ã˜ÂªÃ™â€žÃ˜Â§Ã™â€¦ ////////////////////////////////
...
///////////////////////////////////////sleep case of Ã˜Â±Ã™ï¿½Ã˜Â¶ Ã˜Â§Ã™â€žÃ˜Â¥Ã˜Â³Ã˜ÂªÃ™â€žÃ˜Â§Ã™â€¦ ////////////////////////////////
...
///////////////////////////////////////case of Ã˜Â¥Ã˜Â±Ã˜Â³Ã˜Â§Ã™â€ž Ã™â€žÃ™â€žÃ™â€¦Ã˜Â±Ã˜Â§Ã˜Â¬Ã˜Â¹ ////////////////////////////////
			 ...
			 if (BM_ATT_ROUTE.equals("toReview")&& ((flagCh.equals("false") && flagMa.equals("false")&& flagOS.equals("false")&&flagCh2.equalsIgnoreCase("false"))|| (flagCh.equals("false") && flagMa.equals("true")&& flagOS.equals("false")&&flagCh2.equalsIgnoreCase("false")) )) {
				try {
//					if (BM_ATT_ROUTE.equals("toReview")&& flagCh.equals("false") && flagMa.equals("false")&& flagOS.equals("false"))
//							{
...
///////////////////////////////////////case of Ã˜ÂªÃ™â€¦ Ã˜Â§Ã™â€žÃ˜Â¥Ã˜Â³Ã˜ÂªÃ™â€žÃ˜Â§Ã™â€¦ ////////////////////////////////
					 ...
					 if (BM_ATT_ROUTE.equals("complete")&& flagCh.equals("true") && flagMa.equals("false")&& flagOS.equals("false"))
					 {
						// String date = "2020-01-01";
						 ...
						 System.out.println("date now is :::"+creationDate);
							fnProperties.putObjectValue("ReceivedDate",creationDate);
...
//								+ fnProperties.getStringValue("Maker"));
			 ...
			 if (BM_ATT_ROUTE2.equals("نعم")&& flagCh.equals("false") && flagMa.equals("false") && flagOS.equals("false")&&flagCh2.equalsIgnoreCase("true")){
...
//			 else if (BM_ATT_ROUTE.equals("complete")&flagCh.equals("false") && flagMa.equals("false") && flagOS.equals("false")
//					 &&flagCh2.equalsIgnoreCase("false")){
//				 try {
//					
//					AccessPermissionList permissions = doc.get_Permissions();
...
//								ap_security = Factory.AccessPermission.createInstance();
//								ap_security.set_AccessType(AccessType.ALLOW);
//								ap_security.set_AccessMask(SECURITY_DIApproved);
//								ap_security.set_GranteeName(SecName);
//								permissions.add(i, ap_security);
//								doc.set_Permissions(permissions);
//							}
...
/////////////////////////////////////// case of Ã˜Â±Ã™ï¿½Ã˜Â¶ Ã˜Â§Ã™â€žÃ˜Â¥Ã˜Â³Ã˜ÂªÃ™â€žÃ˜Â§Ã™â€¦ ////////////////////////////////
