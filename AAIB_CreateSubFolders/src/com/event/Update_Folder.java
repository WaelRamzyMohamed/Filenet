			...
			for (Object property : docDefs) {
				...
				for(Object custProp : custFolderDefs)
				{
					...
					//this if to compare match meta data between parent folder class and sub folder class 
					 ...
					 if((custpropdef.get_SymbolicName().equals(docpropdef.get_SymbolicName()) &&( docpropdef.get_SymbolicName().equals("CIF") || 
							docpropdef.get_SymbolicName().equals("Trademark") || 
							docpropdef.get_SymbolicName().equals("English_CustomerName") || docpropdef.get_SymbolicName().equals("Arabic_CustomerName") || 
							docpropdef.get_SymbolicName().equals("Com_RegistrationNumber") || docpropdef.get_SymbolicName().equals("National_ID") || 
							docpropdef.get_SymbolicName().equals("Customer_BrCode_BrName") || docpropdef.get_SymbolicName().equals("Customer_Type")
							))) 
					{
