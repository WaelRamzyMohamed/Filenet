...
public class WorkFlowChecker implements EventActionHandler {
	...
	public void onEvent(ObjectChangeEvent event, Id subId) {
		...
		try {
			...
			String flagCh = fnProperties.getStringValue("CA_Checker");
			String flagMa = fnProperties.getStringValue("CA_Maker");

			
String AAIB_ATT_ROUTE = fnProperties.getStringValue("Statues");


 		///////////////////////////////////////sleep case of ////////////////////////////////
			
		 if (AAIB_ATT_ROUTE.equals("toReview") && flagCh.equals("false") && flagMa.equalsIgnoreCase("false") ) {
				System.out.println("IntercomJavaEventHandler::onEvent():: Subscription to Sleep");
			}
///////////////////////////////////////sleep case of  ////////////////////////////////
		 
				if (AAIB_ATT_ROUTE.equals("Delivered") && flagCh.equals("true") && flagMa.equalsIgnoreCase("false")) {
					System.out.println("IntercomJavaEventHandler::onEvent():: Subscription to Sleep");
...
///////////////////////////////////////case of  ////////////////////////////////
			 ...
			 if (AAIB_ATT_ROUTE.equals("toReview")&& ((flagCh.equals("false") && flagMa.equals("false")))) {
				try {
...
//					}
					...
					fnProperties.putValue("CA_Checker", FCh);
					fnProperties.putValue("CA_Maker", Fm);	
...
///////////////////////////////////////case of  ////////////////////////////////
			 ...
			 if (AAIB_ATT_ROUTE.equals("toCorrect")&& flagCh.equals("true") && flagMa.equals("false")){
...
//					 }
			 ...
			 ///////////////////////
			 if (AAIB_ATT_ROUTE.equals("toReview")&& ((flagCh.equals("false") && flagMa.equals("true")))) {
					try {
//						if (BM_ATT_ROUTE.equals("toReview")&& flagCh.equals("false") && flagMa.equals("false")&& flagOS.equals("false")&&flagCh2.equalsIgnoreCase("false"))
//								{
//							fnProperties.putValue("RecipientName","null");
...
//						}
			 ...
			 if (AAIB_ATT_ROUTE.equals("Approved")&& ((flagCh.equals("true") && flagMa.equals("false")))) {
					try {
//						if (BM_ATT_ROUTE.equals("toReview")&& flagCh.equals("false") && flagMa.equals("false")&& flagOS.equals("false")&&flagCh2.equalsIgnoreCase("false"))
//								{
//							fnProperties.putValue("RecipientName","null");
